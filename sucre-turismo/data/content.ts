...
export const siteData = {
  // Hero Section
  hero: {
    title: "Descubre Sucre y su\ntesoro de belleza sin igual",
    subtitle:
  ...
  hotelsCovenas: [
    {
      ...
      phone: ["+57 310 593 5762", "+57 320 634 5598"],
    ...
    },
    {
      ...
      discount: "",
      contact: "",
      phone: ["+57 304 111 7804", "+57 313 472 5797"],
  ...
  hotelsSincelejo: [
    ...
    },
    {
      ...
      discount: "",
      contact: "",
      phone: ["+57 5 276 5555", "+57 318 330 9737"],
    ...
    },
    {
      ...
      discount: "",
      contact: "",
      phone: ["+57 5 282 1884", "+57 320 531 8154"],
  ...
  operators: [
    ...
    },
    {
      ...
      phone: ["+57 304 666 3693", "+57 320 548 8336"],
    ...
    {
      name: "ALOHA ESCUELA NÁUTICA",
      tagline: "Paddle SUP Experience",
      description: "Tu puerta de entrada al mundo del stand up paddle board (SUP). Experiencias únicas e inolvidables para todos los niveles, desde principiantes hasta riders experimentados.",
      phone: "+57 310 307 3090",
      email: "alohacovenassup@gmail.com",
      website: "https://alohaescuelanautica.com/",
      socials: {
        instagram: "https://www.instagram.com/aloha_cov/",
        facebook: "https://www.facebook.com/alohacov",
      },
      brochure: "/brochures/aloha-escuela-nautica-brochure.pdf",
      image: "/aloha.jpg",
      experiences: [
        'Plan Amigos: Ruta a puntos turísticos - Muelle Antiguo, Piedra Flotante, Hotel Poblado, Muelle Punta de Piedra',
        'Sunrise o Sunset: Ruta para ver el amanecer o atardecer',
        'Boca de la Ciénaga: Ruta en la Ciénaga de la Caimanera para reconocer fauna costera',
